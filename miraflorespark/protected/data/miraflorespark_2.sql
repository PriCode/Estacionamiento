...
INSERT INTO `cliente`(`nombre`, `ape_materno`, `ape_paterno`, `tipo_persona`, `direccion`) VALUES ('Carlos','Cardenas','Paredes','Natural','Av. Los pinos');

INSERT INTO `cliente`(`nombre`, `ape_materno`, `ape_paterno`, `tipo_persona`, `direccion`) VALUES ('Mariano','Rioja','Pascual','Natural','Jr las palmeras');


INSERT INTO `cliente`(`nombre`, `ape_materno`, `ape_paterno`, `tipo_persona`, `direccion`) VALUES ('Jorge','Miranda','Diman','Natural','Calle las plantanos');


INSERT INTO `cliente`(`nombre`, `ape_materno`, `ape_paterno`, `tipo_persona`, `direccion`) VALUES ('Ana','Rivales','Liberales','Natural','Jr los planetas');
